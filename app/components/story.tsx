    ...
    useGSAP(() => {
        ...
        gsap.to(wrapper, {
            ...
            scrollTrigger: {
                ...
                scrub: 1,
                start: "top top",
              end: () =>"+=" + ((wrapper.scrollWidth - storyContainer.current!.clientWidth)+ window.innerWidth * 0.8 ),
		...
		<section ref={storyContainer} id="our-story" className=" bg-[#2b0503]  flex relative overflow-hidden">
            ...
            <div className=" lg:hidden absolute bottom-20 left-6 z-[100]">
                <div className="flex items-center gap-5">
                    <button onClick={handleLeftSlide} className={`flex-none size-8 ${currentSlide === 0 ? 'bg-black' : 'bg-[#fb0015]'} flex items-center justify-center text-text`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5 8.25 12l7.5-7.5" />
                        </svg>
                    </button>

                    <button onClick={handleRightSlide} className={`flex-none size-8 ${currentSlide === 0 ? 'bg-[#fb0015]' : 'bg-black'} flex items-center justify-center text-text`}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
